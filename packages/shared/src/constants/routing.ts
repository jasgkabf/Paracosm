export const ROUTING_ROUND_ROBIN = 'round_robin' as const;
export const ROUTING_LEAST_LATENCY = 'least_latency' as const;
export const ROUTING_COST_OPTIMIZED = 'cost_optimized' as const;
export const ROUTING_QUALITY_OPTIMIZED = 'quality_optimized' as const;
export const ROUTING_ADAPTIVE = 'adaptive' as const;
export const ROUTING_MANUAL = 'manual' as const;
